...
--
-- Déchargement des données de la table `liste_compte`
--

INSERT INTO `liste_compte` (`ID`, `Nom`, `Prenom`, `Mot_de_passe`, `solde`) VALUES
(1, 'musk', 'elon', 'twinboys', 10000),
(2, 'bezos', 'jeff', '!!#^!#', 99999),
(5, 'aupaysdes', 'alice', 'merveilles', 1);
...
--
-- Index pour la table `liste_compte`
--
ALTER TABLE `liste_compte`
  ADD PRIMARY KEY (`ID`);
...
--
-- AUTO_INCREMENT pour la table `liste_compte`
--
ALTER TABLE `liste_compte`
